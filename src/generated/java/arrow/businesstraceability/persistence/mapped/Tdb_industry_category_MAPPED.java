...
@MappedSuperclass
public class Tdb_industry_category_MAPPED extends Abstract_entity {
    // method for ArrowEntity
    @Override
    public Class<? extends arrow.businesstraceability.persistence.entity.Tdb_industry_category> getEntityClass() {
        return arrow.businesstraceability.persistence.entity.Tdb_industry_category.class;
    }
    ...
    //default constructor
    public Tdb_industry_category_MAPPED() {
    }

    protected Tdb_industry_category_MAPPED(final java.lang.String code) {
