...
@MappedSuperclass
public class Tdb_middle_industry_MAPPED extends Abstract_entity {
    // method for ArrowEntity
    @Override
    public Class<? extends arrow.businesstraceability.persistence.entity.Tdb_middle_industry> getEntityClass() {
        return arrow.businesstraceability.persistence.entity.Tdb_middle_industry.class;
    }
    ...
    //default constructor
    public Tdb_middle_industry_MAPPED() {
    }

    protected Tdb_middle_industry_MAPPED(final java.lang.String code) {
