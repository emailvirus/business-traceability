...
/**
 * The Interface EntityPersistedOrUpdated.
 */
@Qualifier
@Target({FIELD, PARAMETER})
@Retention(RUNTIME)
public @interface EntityPersistedOrUpdated {
    ...
    public static class Literal extends AnnotationLiteral<EntityPersistedOrUpdated> implements EntityPersistedOrUpdated {

        /** The value. */
        private Class<? extends BaseEntity> value;

        /* (non-Javadoc)
         * @see arrow.framework.persistence.event.qualifier.EntityPersistedOrUpdated#value()
         */
        @Override
