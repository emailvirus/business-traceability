...
/**
 * The Interface EntityPersistedOrUpdatedOrRemoved.
 */
@Qualifier
@Target({FIELD, PARAMETER})
@Retention(RUNTIME)
public @interface EntityPersistedOrUpdatedOrRemoved {
    ...
    public static class Literal extends AnnotationLiteral<EntityPersistedOrUpdatedOrRemoved> implements
            EntityPersistedOrUpdatedOrRemoved {

        /** The value. */
        private Class<? extends BaseEntity> value;

        /* (non-Javadoc)
         * @see arrow.framework.persistence.event.qualifier.EntityPersistedOrUpdatedOrRemoved#value()
         */
        @Override
