...
/**
 * The Interface EntityPersistedOrRemoved.
 */
@Qualifier
@Target({FIELD, PARAMETER})
@Retention(RUNTIME)
public @interface EntityPersistedOrRemoved {
    ...
    public static class Literal extends AnnotationLiteral<EntityPersistedOrRemoved> implements EntityPersistedOrRemoved {

        /** The value. */
        private Class<? extends BaseEntity> value;

        /* (non-Javadoc)
         * @see arrow.framework.persistence.event.qualifier.EntityPersistedOrRemoved#value()
         */
        @Override
