...
@Retention(RUNTIME)
public @interface BaseEntityManagerCreated {

    /** The Constant LITERAL. */
    public static final AnnotationLiteral<BaseEntityManagerCreated> LITERAL =
            new AnnotationLiteral<BaseEntityManagerCreated>() {};
}
