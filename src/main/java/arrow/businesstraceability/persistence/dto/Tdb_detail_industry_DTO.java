...
public class Tdb_detail_industry_DTO extends Tdb_detail_industry {
    private Tdb_detail_industry_MAPPED.Pk pk;

    public void setPk(final Tdb_detail_industry_MAPPED.Pk pk) {
        this.pk = pk;
    }
    
    @Override
    public Tdb_detail_industry_MAPPED.Pk getPk() {
        return this.pk;
    }
