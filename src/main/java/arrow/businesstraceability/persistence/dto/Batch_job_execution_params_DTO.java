...
public class Batch_job_execution_params_DTO extends Batch_job_execution_params {
    private Batch_job_execution_params_MAPPED.Pk pk;

    public void setPk(final Batch_job_execution_params_MAPPED.Pk pk) {
        this.pk = pk;
    }
    
    @Override
    public Batch_job_execution_params_MAPPED.Pk getPk() {
        return this.pk;
    }
