...
public class San_com_live_stat_DTO extends San_com_live_stat {
    private San_com_live_stat_MAPPED.Pk pk;

    public void setPk(final San_com_live_stat_MAPPED.Pk pk) {
        this.pk = pk;
    }
    
    @Override
    public San_com_live_stat_MAPPED.Pk getPk() {
        return this.pk;
    }
