...
public class Acc_com_bugyo14_DTO extends Acc_com_bugyo14 {
    private Acc_com_bugyo14_MAPPED.Pk pk;

    public void setPk(final Acc_com_bugyo14_MAPPED.Pk pk) {
        this.pk = pk;
    }
    
    @Override
    public Acc_com_bugyo14_MAPPED.Pk getPk() {
        return this.pk;
    }
