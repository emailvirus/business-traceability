...
public class Monthly_report_history_DTO extends Monthly_report_history {
    private Monthly_report_history_MAPPED.Pk pk;

    public void setPk(final Monthly_report_history_MAPPED.Pk pk) {
        this.pk = pk;
    }
    
    @Override
    public Monthly_report_history_MAPPED.Pk getPk() {
        return this.pk;
    }
    ...
    private java.lang.String sousa;
    ...
    public void setSousa(final java.lang.String sousa) {
        this.sousa = sousa;
    }
