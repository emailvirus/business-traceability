...
public class San_com_whole_card_DTO extends San_com_whole_card {
    private San_com_whole_card_MAPPED.Pk pk;

    public void setPk(final San_com_whole_card_MAPPED.Pk pk) {
        this.pk = pk;
    }
    
    @Override
    public San_com_whole_card_MAPPED.Pk getPk() {
        return this.pk;
    }
