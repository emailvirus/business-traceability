...
public class Acc_com_bugyo91_DTO extends Acc_com_bugyo91 {
    private Acc_com_bugyo91_MAPPED.Pk pk;

    public void setPk(final Acc_com_bugyo91_MAPPED.Pk pk) {
        this.pk = pk;
    }
    
    @Override
    public Acc_com_bugyo91_MAPPED.Pk getPk() {
        return this.pk;
    }
