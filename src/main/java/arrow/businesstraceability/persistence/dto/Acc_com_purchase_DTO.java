...
import arrow.businesstraceability.persistence.entity.Acc_com_purchase;

/*=================== End of import section before the marker line ===================*/
/*=================== There must be one blank line before the marker line ===================*/

public class Acc_com_purchase_DTO extends Acc_com_purchase {
    private Acc_com_purchase_MAPPED.Pk pk;

    public void setPk(final Acc_com_purchase_MAPPED.Pk pk) {
        this.pk = pk;
    }
    
    @Override
    public Acc_com_purchase_MAPPED.Pk getPk() {
        return this.pk;
    }
