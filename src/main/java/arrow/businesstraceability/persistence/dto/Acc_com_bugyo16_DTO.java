...
public class Acc_com_bugyo16_DTO extends Acc_com_bugyo16 {
    private Acc_com_bugyo16_MAPPED.Pk pk;

    public void setPk(final Acc_com_bugyo16_MAPPED.Pk pk) {
        this.pk = pk;
    }
    
    @Override
    public Acc_com_bugyo16_MAPPED.Pk getPk() {
        return this.pk;
    }
