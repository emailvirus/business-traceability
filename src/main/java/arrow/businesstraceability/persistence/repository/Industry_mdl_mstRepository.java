...
@Repository
public abstract class Industry_mdl_mstRepository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Industry_mdl_mst, Industry_mdl_mst_MAPPED.Pk> {
    //@formatter:on
