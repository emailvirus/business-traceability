...
@Repository
public abstract class Acc_com_bugyo91Repository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Acc_com_bugyo91, Acc_com_bugyo91_MAPPED.Pk> {
    //@formatter:on
