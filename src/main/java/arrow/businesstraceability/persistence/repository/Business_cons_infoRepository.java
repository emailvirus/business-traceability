...
@Repository
public abstract class Business_cons_infoRepository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Business_cons_info, Business_cons_info_MAPPED.Pk> {
    //@formatter:on
