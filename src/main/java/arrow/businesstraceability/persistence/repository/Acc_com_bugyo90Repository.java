...
@Repository
public abstract class Acc_com_bugyo90Repository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Acc_com_bugyo90, Acc_com_bugyo90_MAPPED.Pk> {
    //@formatter:on
