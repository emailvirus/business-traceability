...
@Repository
public abstract class Acc_com_bugyo16Repository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Acc_com_bugyo16, Acc_com_bugyo16_MAPPED.Pk> {
    //@formatter:on
