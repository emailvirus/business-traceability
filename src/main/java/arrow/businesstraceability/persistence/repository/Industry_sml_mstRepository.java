...
@Repository
public abstract class Industry_sml_mstRepository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Industry_sml_mst, Industry_sml_mst_MAPPED.Pk> {
    //@formatter:on
