...
@Repository
public abstract class Industry_big_infoRepository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Industry_big_info, Industry_big_info_MAPPED.Pk> {
    //@formatter:on
