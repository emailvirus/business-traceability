...
@Repository
public abstract class Tdb_big_industryRepository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Tdb_big_industry, Tdb_big_industry_MAPPED.Pk> {
    //@formatter:on
