...
@Repository
public abstract class Authority_mstRepository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Authority_mst, Authority_mst_MAPPED.Pk> {
    //@formatter:on
