...
@Repository
public abstract class San_com_live_statRepository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<San_com_live_stat, San_com_live_stat_MAPPED.Pk> {
    //@formatter:on
