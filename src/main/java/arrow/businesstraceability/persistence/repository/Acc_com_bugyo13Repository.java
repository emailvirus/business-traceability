...
@Repository
public abstract class Acc_com_bugyo13Repository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Acc_com_bugyo13, Acc_com_bugyo13_MAPPED.Pk> {
    //@formatter:on
