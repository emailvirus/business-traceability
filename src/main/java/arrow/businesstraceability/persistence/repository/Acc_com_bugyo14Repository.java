...
@Repository
public abstract class Acc_com_bugyo14Repository extends arrow.framework.persistence.Abstract_entityRepositoryWrapper<Acc_com_bugyo14, Acc_com_bugyo14_MAPPED.Pk> {
    //@formatter:on
